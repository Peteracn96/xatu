...
void ScreeningConfiguration::checkContentCoherence(){
    ...
    if(screeningInfo.d < 0){
        throw std::invalid_argument("The thickness of the material must be positive or null. (For zero thickness, remove the argument from the screening configuration file)temp");
    }
};
